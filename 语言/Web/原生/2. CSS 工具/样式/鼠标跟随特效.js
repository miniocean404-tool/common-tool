...
function createMouseCanvas() {
    ...
    (_createClass(t, [
      {
        ...
        value: function (t) {
          ...
          !(function () {
            for (var a = 0, t = ["webkit", "moz"], e = 0; e < t.length && !window.requestAnimationFrame; ++e)
          ...
          i >= 1 && i < 11 && this.mouseType1(this.defaults.type, this.defaults.color),
        ...
        value: function (type, color) {
          ...
          window.addEventListener("mousemove", function (t) {
            ;(a = t.pageX - getOffset(canvasDom).left),
              ...
              type == 4 &&
                (Math.random() <= 0.5
                  ? ((d = Math.random() <= 0.5 ? -10 : n + 10), (f = Math.random() * o))
                  : ((f = Math.random() <= 0.5 ? -10 : o + 10), (d = Math.random() * n)),
                (u = 8 * (Math.random() - 0.5)),
                (y = 8 * (Math.random() - 0.5))),
            ...
            (function t() {
              if (type == 1) {
                ...
                for (w += 5, ctx.clearRect(0, 0, n, o), e = 0; e < l.length; e++)
                  (ctx.globalAlpha = l[e].o),
                    (ctx.fillStyle = getColor),
                    ctx.beginPath(),
                    (ctx.shadowBlur = 20),
                ...
                for (
                  ...
                  (ctx.globalAlpha = l[e].o),
                    ...
                    l[e].o <= 0 &&
                      ...
                      (l[e].x = a + 100 * (Math.random() - 0.5) * Math.cos(l[e].h)),
                      (l[e].y = h + 100 * (Math.random() - 0.5) * Math.sin(l[e].h)),
                      (l[e].o = 1))
              else if (type == 8)
                for (
                  ctx.clearRect(0, 0, n, o),
                    ctx.fillStyle = getColor,
                    a % 4 == 0 ? (a += 1) : a % 4 == 2 ? --a : a % 4 == 3 && (a -= 2),
                    h % 4 == 0 ? (h += 1) : h % 4 == 2 ? --h : h % 4 == 3 && (h -= 2),
                    e = a - 60;
                  e < a + 60;
                  e += 4
                )
                  for (let i = h - 60; i < h + 60; i += 4)
                    Math.sqrt(Math.pow(a - e, 2) + Math.pow(h - i, 2)) <= 60 &&
                      ((ctx.globalAlpha = 1 - Math.sqrt(Math.pow(a - e, 2) + Math.pow(h - i, 2)) / 60),
                ...
                for (
                  ctx.clearRect(0, 0, n, o),
                    ...
                    a % 4 == 0 ? (a += 1) : a % 4 == 2 ? --a : a % 4 == 3 && (a -= 2),
                    h % 4 == 0 ? (h += 1) : h % 4 == 2 ? --h : h % 4 == 3 && (h -= 2),
                    l.length < c.n && l.push({ x: a, y: h, xv: 0, yv: 0, o: 1 }),
                    e = 0;
                  e < l.length;
                  e++
                )
                  l[e].xv == 0 && l[e].yv == 0
                    ? Math.random() < 0.5
                      ...
                      : (l[e].yv = -3)
                    : l[e].xv == 0
                    ? Math.random() < 0.66 && ((l[e].yv = 0), Math.random() < 0.5 ? (l[e].xv = 3) : (l[e].xv = -3))
                    : l[e].yv == 0 &&
                      Math.random() < 0.66 &&
                      ((l[e].xv = 0), Math.random() < 0.5 ? (l[e].yv = 3) : (l[e].yv = -3)),
                    (l[e].o -= c.o / 2),
                    (ctx.globalAlpha = l[e].o),
                    (l[e].x += l[e].xv),
                    (l[e].y += l[e].yv),
      ...
      },
      {
        ...
        value: function () {
          ...
          let u = !1
          function e(t) {
            ;(d = t.clientX - 0.5 * (window.innerWidth - h)), (f = t.clientY - 0.5 * (window.innerHeight - s))
          }
          function y(t) {
            u = !0
          }
              ...
              t.prototype = {
                setXY: function () {
                  ...
                  this.obj,
                    (t = "mousemove"),
                    (e = function (t) {
                      ;(t = t || window.event), (a.x = t.clientX), (a.y = t.clientY)
                    }),
  ...
  // 赋值 给一个默认值
  function t() {
    _classCallCheck(this, t), (this.defaults = { type: 1, color: !1 }), (this.version = "0.0.1")
  }
