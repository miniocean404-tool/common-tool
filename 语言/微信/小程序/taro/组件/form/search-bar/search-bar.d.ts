...
import DavComponent from "@/typing/components/base"

export interface DavSearchBarProps extends DavComponent {
  /**
   * 输入框当前值
   * @type {string}
...
declare const DavSearchBar: ComponentClass<DavSearchBarProps>
