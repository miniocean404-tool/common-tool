...
pngtiny.instantiateWasm = function (importObject, receiveInstance) {
  fetch(new URL("./pngtiny.wasm", import.meta.url))
...
if ("object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node) {
  ...
  p ? (q = self.location.href) : "undefined" != typeof document && document.currentScript && (q = document.currentScript.src),
...
;(function () {
  ...
  ;(function () {
    return B || "function" != typeof WebAssembly.instantiateStreaming || la() || M.startsWith("file://") || "function" != typeof fetch
      ? f(c)
